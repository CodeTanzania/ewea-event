...
// event schema
const EVENT_MODEL_NAME = env.getString('EVENT_MODEL_NAME', 'Event');
const EVENT_COLLECTION_NAME = env.getString(
...
// changelog schema
const CHANGELOG_MODEL_NAME = env.getString(
  'CHANGELOG_MODEL_NAME',
  'EventChangeLog'
);
const CHANGELOG_COLLECTION_NAME = env.getString(
    ...
    number: {
      ...
      sequenceable: {
        prefix: function prefix() {
          return lodash.get(this, 'type.string.name.en', '');
        },
        suffix: COUNTRY_CODE,
        length: 6,
        pad: '0',
...
/* export event model */
const Event = mongooseCommon.model(EVENT_MODEL_NAME, EventSchema);
...
const EventChangeLog = mongooseCommon.model(CHANGELOG_MODEL_NAME, ChangeLogSchema);
